...
# Write the crontab
# Every Sunday, 8:00 AM — retrain model with expanding window (predict.py auto-reloads on next call)
...
(
  echo "0 8 * * 0 . /etc/environment; cd /app && python -m backend.modeling.train_model >> /app/logs/retrain.log 2>&1"
